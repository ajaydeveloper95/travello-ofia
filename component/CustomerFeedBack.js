          ...
          <div className="flex flex-wrap -m-4">
            <div className="p-4 md:w-1/2 w-full">
              <div className="h-full bg-gray-100 p-8 rounded">
                ...
                Great service, everything stated, plus upgrades was done for me, with out any hassle. Would recommend you's to everyone. Very simple and easy. Had a great holiday. Thank you
                </p>
