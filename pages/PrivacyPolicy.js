...
function PrivacyPolicy() {
  return (
    <div className="w-11/12 m-auto my-5">
      <h1 className="text-2xl text-center my-3">Privacy Policy</h1>
      <p className="my-3">Last updated: November 15, 2023</p>
      <p>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to TheBagPacker, sikar,rajsthan 332001.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to TheBagPacker, accessible from{" "}
            <a
              href="https://thebagpacker.in"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://thebagpacker.in
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By phone number: +91 82904 05227</li>
      </ul>
    </div>
  );
}
